...
def superconductive(g_matrix, i_matrix, resistances, r_i):
    ...
    """
    # get rows, corresponding to equations set for nodes on the word line, of g_matrix that contain np.inf elements
    ...
    # some of the information was lost in function g() when np.inf elements were added
    # to matrix g and overrode any existing values; these steps recover that information
    for row in rows:
