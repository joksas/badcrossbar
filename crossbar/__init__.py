...
For most users, function crossbar.currents should complete the main task at hand, i.e. computing output currents of a crossbar array given applied voltages, resistances of crossbar devices and interconnect resistance.
"""
