...
def test_currents_qucs_2x3_a():
    """Tests outputs of badcrossbar.compute.test_currents against results from Qucs. See qucs-files/qucs_2x3_a.sch.
    ...
    computed_currents = badcrossbar.compute(voltages, resistances, r_i=r_i).currents

    compare_currents(computed_currents, expected_currents)


def test_currents_qucs_2x3_b():
    """Tests outputs of badcrossbar.compute.test_currents against results from Qucs. See qucs-files/qucs_2x3_b.sch.
...
def test_currents_qucs_2x3_c():
    """Tests outputs of badcrossbar.compute.test_currents against results from Qucs. See qucs-files/qucs_2x3_c.sch.
...
def test_currents_qucs_2x3_d():
    """Tests outputs of badcrossbar.compute.test_currents against results from Qucs. See qucs-files/qucs_2x3_d.sch.
...
def test_currents_qucs_2x1_a():
    """Tests outputs of badcrossbar.compute.test_currents against results from Qucs. See qucs-files/qucs_2x1_a.sch.
...
def test_currents_qucs_2x1_b():
    """Tests outputs of badcrossbar.compute.test_currents against results from Qucs. See qucs-files/qucs_2x1_b.sch.
...
def test_currents_qucs_2x1_c():
    """Tests outputs of badcrossbar.compute.test_currents against results from Qucs. See qucs-files/qucs_2x1_c.sch.
...
def test_currents_dot_product_engine():
    ...
    for _ in range(10):
        ...
        r_i = 0
        computed_currents = badcrossbar.compute(voltages, resistances, r_i).currents
...
def test_currents_return_only_outputs():
    ...
    voltages = np.random.rand(m, p)
    r_i = 0
    computed_currents = badcrossbar.compute(voltages, resistances, r_i, extract_all=False).currents
...
def test_currents_qucs_2x3_a_only_outputs():
    """Tests output parameter of the output badcrossbar.compute.test_currents against results from Qucs, when passed an argument extract_all=False. See qucs-files/qucs_2x3_a.sch.
    ...
    computed_currents = badcrossbar.compute(voltages, resistances, r_i=r_i, extract_all=False).currents
