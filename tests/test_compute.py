...
@pytest.mark.parametrize('file_name', ['2x3_a', '2x3_c', '2x3_d', '2x1_a', '2x1_b'])
def test_currents_qucs(file_name):
    resistances, voltages, r_i, expected_currents = qucs_data(file_name)
...
def qucs_data(file_name):
    ...
    return resistances, voltages, r_i, expected_currents
